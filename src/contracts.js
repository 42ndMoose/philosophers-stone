...
The LLM should instead output either:
- evidence items
- or a compact profile line
- or both
...
- Escape inner quotation marks correctly.
...
7. The LLM is extracting signals, not declaring final truth.
